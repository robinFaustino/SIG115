...
<div class="panel panel-default">
 	<div class="panel-heading"><center><h4>Indice de reprobado de todos los grados</h4></center></div>
 	<div class="panel-body">
	
 	{!!Form::open(array('url'=>'informe3Extrategico','method'=>'POST','autocomplete'=>'off'))!!}
    {{Form::token()}}	
 	    <div class="row">
